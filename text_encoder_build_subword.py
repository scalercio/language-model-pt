...
import sys
sys.path.insert(1,'/home/arthur/learning/ml_and_dataScience/nlp/repo/tensor2tensor/')
...
tf.flags.DEFINE_integer('min_count', 10, 'Minimum subtoken count in corpus')
tf.flags.DEFINE_integer('corpus_max_lines', 15000,
